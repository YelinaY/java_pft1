...
public class GroupContactHelper extends HelperBase {
  ...
  public void selectGroup(int index) {
   wd.findElements(By.name("selected[]")).get(index).click(); //выбор  по индексу группы из списка
  }
  ...
  public void selectAddressBook(int index) {
      wd.findElements(By.name("selected[]")).get(index).click(); //выбор  по индексу контакта из списка
    }
